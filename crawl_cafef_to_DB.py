...
def extract():
    ...
    # chrome_options.add_argument("--headless")     # Ẩn Web - Chạy nền
    driver = webdriver.Chrome(executable_path='C:\\bin\\chromedriver.exe') # Đường dẫn đến chromedriver (Đã set PATH)
    ...
    logging.info('hi',soup)
    contents = soup.find("tbody").find_all('tr')     # Tìm đến ô chứa bảng dữ liệu - Có được data dưới dạng Tree
